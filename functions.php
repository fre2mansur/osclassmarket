...
function run_if_user_edit($user) {
    set_donation_link($user);
}
function run_if_user_delete($user) {
    delete_donation_link($user);
}
osc_add_hook('posted_item', 'run_if_new');
osc_add_hook('edited_item', 'run_if_edit');
osc_add_hook('delete_item', 'run_if_delete');

osc_add_hook('user_edit_completed', 'run_if_user_edit');
osc_add_hook('delete_user', 'run_if_user_delete');
