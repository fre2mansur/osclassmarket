...
function market_item_new($item){
	market_dao_item_insert($item);
}
osc_add_hook('posted_item', 'market_item_new');

function market_item_edit($item){
	market_dao_item_update($item);
}
osc_add_hook('edited_item', 'market_item_edit');

function market_item_delete($item){
	market_dao_item_delete($item);
}
osc_add_hook('delete_item', 'market_item_delete');

function market_user_edit($user) {
    market_dao_user_insert_update($user);
}
osc_add_hook('user_edit_completed', 'market_user_edit');

function market_user_delete($user) {
