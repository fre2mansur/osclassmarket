                ...
                <form action="<?php echo osc_base_url(true); ?>" method="post">
                   ...
                   <div class="form-group">
                        <label class="control-label" for="name"><?php _e('Paypal donation page link', 'market'); ?></label>
                      	<input id="donation_link" class="form-control" type="url" value="<?php echo get_donation_link(osc_user_id())?>" name="donation_link"><small>Leave empty if you don't want donation option</small>
                    </div>
                   <?php } ?>  
